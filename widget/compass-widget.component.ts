...
@Component({
    template:
        `
        <svg version="1.0" viewBox="0 0 470 470" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="var(--brand-light)">
            <defs>
                <linearGradient id="a">
            ...
            <path
                    id="compass_needle"
                    style="fill:var(--brand-dark,var(--c8y-palette-low));fill-rule:evenodd;stroke:var(--brand-dark,var(--c8y-palette-low));stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
